	...
	<article class="inner-content">
		<div id="reservation">
			<article class="reserve-info">
				<p>
					The bunkhouse is a large comfortable rustic style room. The bunkhouse has a queen size bed, a set of bunk beds and a private bathroom with shower. There is a large wrap around covered porch with two fire pits available to keep you warm on chilly nights.
				</p>
				<hr>
				<div class="list">
